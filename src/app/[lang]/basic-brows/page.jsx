      ...
      <Section id="brows_courses_theory">
        ...
        <div className="my-8 pb-16">
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            <div className="bg-lightBgColor relative p-5 rounded-md mt-14 flex-1 shadow-md">
              ...
              <ul className="text-lg font-light list-disc  list-inside">
                <li className="pl-3">
                  {t(
                    "The structure of hair and skin, hair growth phases, and its chemical composition."
                  )}
                </li>
                <li className="pl-3">
                  {t(
                    "The effect of hair porosity on coloring and how to prepare different skin types for the procedure."
                  )}
                </li>
                <li className="pl-3">
                  {t(
                    "Brow geometry, preliminary drawing techniques, coloring with dye and henna, and brow shaping with tweezers and wax."
                  )}
                </li>
                <li className="pl-3">
                  {t(
                    "Contraindications for the procedure and recommendations for the client."
                  )}
                </li>
              </ul>
            </div>
          ...
          <p className="mt-6 text-lg font-light">
            *{" "}
            {t(
              "The training also provides meals and beverages for the participants."
            )}
          </p>
        </div>
      ...
      <Section id="brows_advatage" className="brow-advantage-section">
        ...
        <TrainingAdvantageList>
          <TrainingAdvantage
            ...
            stepDescription={t(
              "I have 4 years of practice as a brow and lash stylist, during which I have served over 500 satisfied clients. My experience allows me to share proven techniques and best practices."
            )}
          />
          <TrainingAdvantage
            ...
            stepDescription={t(
              "I regularly attend courses and training to stay updated with the latest trends and techniques in the industry. This ensures that my training is always current and based on the latest advancements."
            )}
          />
          <TrainingAdvantage
            ...
            stepDescription={t(
              "Since 2021, I have been conducting training for trainees from all over Poland and other countries. My approach is universal and adapted to different markets, ensuring that every trainee, regardless of location, gains valuable knowledge."
            )}
          />
          <TrainingAdvantage
            ...
            stepDescription={t(
              "Every trainee is unique to me, so I tailor the training program to their individual needs and skill levels. I ensure that everyone feels comfortable and confident in acquiring new skills."
            )}
          />
          <TrainingAdvantage
            ...
            stepDescription={t(
              "My support does not end with the completion of the course. I provide trainees with support even after the training, offering consultations, advice, and access to educational materials. I care about the development of my trainees and their professional success."
            )}
          />
        </TrainingAdvantageList>
      </Section>
